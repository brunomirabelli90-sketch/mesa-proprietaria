...
class PainelLeilao:
    def __init__(self, root):
        ...
        cabecalho.pack(fill="x", padx=16, pady=(16, 8))
        tk.Label(
    ...
    def _atualizar(self):
        ...
        self._atualizar_badge(resultado)
        self._atualizar_dados(dados, resultado)
        self._atualizar_indices(dados)
    ...
    def _atualizar_dados(self, dados, r):
        self.linhas_dados["fechamento"].config(text=self._fmt(dados["fechamento"]))
        self.linhas_dados["ajuste"].config(text=self._fmt(dados["ajuste"]))
        self.linhas_dados["teorico"].config(text=self._fmt(dados["teorico"]))
        self.linhas_dados["gap_fechamento"].config(text=formatar_gap(r["gap_fechamento"]))
        self.linhas_dados["gap_ajuste"].config(text=formatar_gap(r["gap_ajuste"]))
